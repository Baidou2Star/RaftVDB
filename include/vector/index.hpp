...
#pragma pack(pop) // Reset alignment to default
        ...
        template <typename element_at>
        element_at default_free_value() { return default_free_value_gt<element_at>::value(); }
        ...
        struct dummy_predicate_t
        {
            ...
            constexpr bool operator()(member_at &&) const noexcept { return true; }
        };
        ...
        struct dummy_key_to_key_mapping_t
        {
            struct member_ref_t
            {
                ...
                member_ref_t &operator=(key_at &&) noexcept { return *this; }
            };
            template <typename key_at>
            member_ref_t operator[](key_at &&) const noexcept { return {}; }
        };
         ...
         */
        template <typename at>
        constexpr bool has_reset() { return has_reset_gt<at, void()>::value; }
        ...
        template <typename key_at>
        inline std::size_t get_slot(member_gt<key_at> const &m) noexcept { return m.slot; }
        template <typename key_at>
        inline key_at get_key(member_gt<key_at> const &m) noexcept { return m.key; }
        ...
        template <typename key_at>
        inline std::size_t get_slot(member_cref_gt<key_at> const &m) noexcept { return m.slot; }
        template <typename key_at>
        inline key_at get_key(member_cref_gt<key_at> const &m) noexcept { return m.key; }
        ...
        template <typename key_at>
        inline std::size_t get_slot(member_ref_gt<key_at> const &m) noexcept { return m.slot; }
        template <typename key_at>
        inline key_at get_key(member_ref_gt<key_at> const &m) noexcept { return m.key; }
        ...
        public:
            ...
            class member_iterator_gt
            {
                ...
                template <int>
                ref_t call_key(std::true_type) const noexcept
                {
                    return ref_t{index_->node_at_(slot_).ckey(), slot_};
                }
                template <int>
                ref_t call_key(std::false_type) const noexcept
                {
        ...
        private:
            ...
            public:
                ...
                template <typename allow_slot_at>
                std::size_t erase_if(allow_slot_at &&allow_slot) noexcept
                {
                ...
                level_t level, context_t &context) usearch_noexcept_m
            {
                ...
                for (auto new_neighbor : new_neighbors)
                {
                    ...
                    if (std::find_if(close_header.begin(), close_header.end(),
                                     ...
                                     { return slot == new_slot; }) != close_header.end())
                    {
                        continue;
                    }
