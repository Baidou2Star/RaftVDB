...
#include <vector/index.hpp> // `expected_gt` and macros
...
namespace unum
{
    namespace usearch
    {
        ...
        at angle_to_radians(at angle) noexcept { return angle * at(3.14159265358979323846) / at(180); }

        /**
         *  @brief  Readability helper to compute the square of a given value.
         */
        template <typename at>
        at square(at value) noexcept { return value * value; }
    ...
    initializer(omp_priv = unum::usearch::e3m2_bits_t())
        ...
        class executor_stl_t
        {
            ...
            struct jthread_t
            {
                ...
                jthread_t(callable_at &&func) : native_([=]()
                                                        { func(); }),
                                                initialized_(true) {}
...
#pragma omp parallel
        ...
        template <>
        struct cast_gt<i8_t, f16_bits_t> : public cast_from_i8_gt<f16_t>
        {
        };
        template <>
        struct cast_gt<i8_t, bf16_bits_t> : public cast_from_i8_gt<bf16_t>
        {
        };
        template <>
        struct cast_gt<i8_t, f32_t> : public cast_from_i8_gt<f32_t>
        {
        };
        template <>
        struct cast_gt<i8_t, f64_t> : public cast_from_i8_gt<f64_t>
        {
        };

        template <>
        struct cast_gt<f16_bits_t, i8_t> : public cast_to_i8_gt<f16_t>
        {
        };
        template <>
        struct cast_gt<bf16_bits_t, i8_t> : public cast_to_i8_gt<bf16_t>
        {
        };
        template <>
        struct cast_gt<f32_t, i8_t> : public cast_to_i8_gt<f32_t>
        {
        };
        template <>
        struct cast_gt<f64_t, i8_t> : public cast_to_i8_gt<f64_t>
        {
        };

        template <>
        struct cast_gt<b1x8_t, f16_bits_t> : public cast_from_b1x8_gt<f16_t>
        {
        };
        template <>
        struct cast_gt<b1x8_t, bf16_bits_t> : public cast_from_b1x8_gt<bf16_t>
        {
        };
        template <>
        struct cast_gt<b1x8_t, f32_t> : public cast_from_b1x8_gt<f32_t>
        {
        };
        template <>
        struct cast_gt<b1x8_t, f64_t> : public cast_from_b1x8_gt<f64_t>
        {
        };

        template <>
        struct cast_gt<f16_bits_t, b1x8_t> : public cast_to_b1x8_gt<f16_t>
        {
        };
        template <>
        struct cast_gt<bf16_bits_t, b1x8_t> : public cast_to_b1x8_gt<bf16_t>
        {
        };
        template <>
        struct cast_gt<f32_t, b1x8_t> : public cast_to_b1x8_gt<f32_t>
        {
        };
        template <>
        struct cast_gt<f64_t, b1x8_t> : public cast_to_b1x8_gt<f64_t>
        {
        };

        template <>
        struct cast_gt<b1x8_t, i8_t> : public cast_from_b1x8_gt<i8_t>
        {
        };
        template <>
        struct cast_gt<i8_t, b1x8_t> : public cast_to_b1x8_gt<i8_t>
        {
        };

        template <typename from_at, typename to_at>
        struct cast_through_f32_gt
        {
            static bool try_(byte_t const *input, std::size_t dim, byte_t *output) noexcept
            {
        ...
        template <>
        struct cast_gt<e5m2_bits_t, e5m2_bits_t>
        {
            static bool try_(byte_t const *, std::size_t, byte_t *) noexcept { return false; }
        };
        template <>
        struct cast_gt<e5m2_bits_t, f32_t> : public cast_through_f32_gt<e5m2_t, f32_t>
        {
        };
        template <>
        struct cast_gt<f32_t, e5m2_bits_t> : public cast_through_f32_gt<f32_t, e5m2_t>
        {
        };
        template <>
        struct cast_gt<e5m2_bits_t, f64_t> : public cast_through_f32_gt<e5m2_t, f64_t>
        {
        };
        template <>
        struct cast_gt<f64_t, e5m2_bits_t> : public cast_through_f32_gt<f64_t, e5m2_t>
        {
        };
        template <>
        struct cast_gt<e5m2_bits_t, f16_bits_t> : public cast_through_f32_gt<e5m2_t, f16_t>
        {
        };
        template <>
        struct cast_gt<f16_bits_t, e5m2_bits_t> : public cast_through_f32_gt<f16_t, e5m2_t>
        {
        };
        template <>
        struct cast_gt<e5m2_bits_t, bf16_bits_t> : public cast_through_f32_gt<e5m2_t, bf16_t>
        {
        };
        template <>
        struct cast_gt<bf16_bits_t, e5m2_bits_t> : public cast_through_f32_gt<bf16_t, e5m2_t>
        {
        };
        template <>
        struct cast_gt<e5m2_bits_t, i8_t> : public cast_to_i8_gt<e5m2_t>
        {
        };
        template <>
        struct cast_gt<i8_t, e5m2_bits_t> : public cast_from_i8_gt<e5m2_t>
        {
        };
        template <>
        struct cast_gt<e5m2_bits_t, b1x8_t> : public cast_to_b1x8_gt<e5m2_t>
        {
        };
        template <>
        struct cast_gt<b1x8_t, e5m2_bits_t> : public cast_from_b1x8_gt<e5m2_t>
        {
        };

        template <>
        struct cast_gt<e4m3_bits_t, e4m3_bits_t>
        {
            static bool try_(byte_t const *, std::size_t, byte_t *) noexcept { return false; }
        };
        template <>
        struct cast_gt<e4m3_bits_t, f32_t> : public cast_through_f32_gt<e4m3_t, f32_t>
        {
        };
        template <>
        struct cast_gt<f32_t, e4m3_bits_t> : public cast_through_f32_gt<f32_t, e4m3_t>
        {
        };
        template <>
        struct cast_gt<e4m3_bits_t, f64_t> : public cast_through_f32_gt<e4m3_t, f64_t>
        {
        };
        template <>
        struct cast_gt<f64_t, e4m3_bits_t> : public cast_through_f32_gt<f64_t, e4m3_t>
        {
        };
        template <>
        struct cast_gt<e4m3_bits_t, f16_bits_t> : public cast_through_f32_gt<e4m3_t, f16_t>
        {
        };
        template <>
        struct cast_gt<f16_bits_t, e4m3_bits_t> : public cast_through_f32_gt<f16_t, e4m3_t>
        {
        };
        template <>
        struct cast_gt<e4m3_bits_t, bf16_bits_t> : public cast_through_f32_gt<e4m3_t, bf16_t>
        {
        };
        template <>
        struct cast_gt<bf16_bits_t, e4m3_bits_t> : public cast_through_f32_gt<bf16_t, e4m3_t>
        {
        };
        template <>
        struct cast_gt<e4m3_bits_t, i8_t> : public cast_to_i8_gt<e4m3_t>
        {
        };
        template <>
        struct cast_gt<i8_t, e4m3_bits_t> : public cast_from_i8_gt<e4m3_t>
        {
        };
        template <>
        struct cast_gt<e4m3_bits_t, b1x8_t> : public cast_to_b1x8_gt<e4m3_t>
        {
        };
        template <>
        struct cast_gt<b1x8_t, e4m3_bits_t> : public cast_from_b1x8_gt<e4m3_t>
        {
        };

        template <>
        struct cast_gt<e2m3_bits_t, e2m3_bits_t>
        {
            static bool try_(byte_t const *, std::size_t, byte_t *) noexcept { return false; }
        };
        template <>
        struct cast_gt<e2m3_bits_t, f32_t> : public cast_through_f32_gt<e2m3_t, f32_t>
        {
        };
        template <>
        struct cast_gt<f32_t, e2m3_bits_t> : public cast_through_f32_gt<f32_t, e2m3_t>
        {
        };
        template <>
        struct cast_gt<e2m3_bits_t, f64_t> : public cast_through_f32_gt<e2m3_t, f64_t>
        {
        };
        template <>
        struct cast_gt<f64_t, e2m3_bits_t> : public cast_through_f32_gt<f64_t, e2m3_t>
        {
        };
        template <>
        struct cast_gt<e2m3_bits_t, f16_bits_t> : public cast_through_f32_gt<e2m3_t, f16_t>
        {
        };
        template <>
        struct cast_gt<f16_bits_t, e2m3_bits_t> : public cast_through_f32_gt<f16_t, e2m3_t>
        {
        };
        template <>
        struct cast_gt<e2m3_bits_t, bf16_bits_t> : public cast_through_f32_gt<e2m3_t, bf16_t>
        {
        };
        template <>
        struct cast_gt<bf16_bits_t, e2m3_bits_t> : public cast_through_f32_gt<bf16_t, e2m3_t>
        {
        };
        template <>
        struct cast_gt<e2m3_bits_t, i8_t> : public cast_to_i8_gt<e2m3_t>
        {
        };
        template <>
        struct cast_gt<i8_t, e2m3_bits_t> : public cast_from_i8_gt<e2m3_t>
        {
        };
        template <>
        struct cast_gt<e2m3_bits_t, b1x8_t> : public cast_to_b1x8_gt<e2m3_t>
        {
        };
        template <>
        struct cast_gt<b1x8_t, e2m3_bits_t> : public cast_from_b1x8_gt<e2m3_t>
        {
        };

        template <>
        struct cast_gt<e3m2_bits_t, e3m2_bits_t>
        {
            static bool try_(byte_t const *, std::size_t, byte_t *) noexcept { return false; }
        };
        template <>
        struct cast_gt<e3m2_bits_t, f32_t> : public cast_through_f32_gt<e3m2_t, f32_t>
        {
        };
        template <>
        struct cast_gt<f32_t, e3m2_bits_t> : public cast_through_f32_gt<f32_t, e3m2_t>
        {
        };
        template <>
        struct cast_gt<e3m2_bits_t, f64_t> : public cast_through_f32_gt<e3m2_t, f64_t>
        {
        };
        template <>
        struct cast_gt<f64_t, e3m2_bits_t> : public cast_through_f32_gt<f64_t, e3m2_t>
        {
        };
        template <>
        struct cast_gt<e3m2_bits_t, f16_bits_t> : public cast_through_f32_gt<e3m2_t, f16_t>
        {
        };
        template <>
        struct cast_gt<f16_bits_t, e3m2_bits_t> : public cast_through_f32_gt<f16_t, e3m2_t>
        {
        };
        template <>
        struct cast_gt<e3m2_bits_t, bf16_bits_t> : public cast_through_f32_gt<e3m2_t, bf16_t>
        {
        };
        template <>
        struct cast_gt<bf16_bits_t, e3m2_bits_t> : public cast_through_f32_gt<bf16_t, e3m2_t>
        {
        };
        template <>
        struct cast_gt<e3m2_bits_t, i8_t> : public cast_to_i8_gt<e3m2_t>
        {
        };
        template <>
        struct cast_gt<i8_t, e3m2_bits_t> : public cast_from_i8_gt<e3m2_t>
        {
        };
        template <>
        struct cast_gt<e3m2_bits_t, b1x8_t> : public cast_to_b1x8_gt<e3m2_t>
        {
        };
        template <>
        struct cast_gt<b1x8_t, e3m2_bits_t> : public cast_from_b1x8_gt<e3m2_t>
        {
        };

        template <>
        struct cast_gt<u8_t, f16_bits_t> : public cast_from_u8_gt<f16_t>
        {
        };
        template <>
        struct cast_gt<u8_t, bf16_bits_t> : public cast_from_u8_gt<bf16_t>
        {
        };
        template <>
        struct cast_gt<u8_t, f32_t> : public cast_from_u8_gt<f32_t>
        {
        };
        template <>
        struct cast_gt<u8_t, f64_t> : public cast_from_u8_gt<f64_t>
        {
        };
        template <>
        struct cast_gt<f16_bits_t, u8_t> : public cast_to_u8_gt<f16_t>
        {
        };
        template <>
        struct cast_gt<bf16_bits_t, u8_t> : public cast_to_u8_gt<bf16_t>
        {
        };
        template <>
        struct cast_gt<f32_t, u8_t> : public cast_to_u8_gt<f32_t>
        {
        };
        template <>
        struct cast_gt<f64_t, u8_t> : public cast_to_u8_gt<f64_t>
        {
        };
        template <>
        struct cast_gt<b1x8_t, u8_t> : public cast_from_b1x8_gt<u8_t>
        {
        };
        template <>
        struct cast_gt<u8_t, b1x8_t> : public cast_to_b1x8_gt<u8_t>
        {
        };
        template <>
        struct cast_gt<e5m2_bits_t, u8_t> : public cast_to_u8_gt<e5m2_t>
        {
        };
        template <>
        struct cast_gt<u8_t, e5m2_bits_t> : public cast_from_u8_gt<e5m2_t>
        {
        };
        template <>
        struct cast_gt<e4m3_bits_t, u8_t> : public cast_to_u8_gt<e4m3_t>
        {
        };
        template <>
        struct cast_gt<u8_t, e4m3_bits_t> : public cast_from_u8_gt<e4m3_t>
        {
        };
        template <>
        struct cast_gt<e2m3_bits_t, u8_t> : public cast_to_u8_gt<e2m3_t>
        {
        };
        template <>
        struct cast_gt<u8_t, e2m3_bits_t> : public cast_from_u8_gt<e2m3_t>
        {
        };
        template <>
        struct cast_gt<e3m2_bits_t, u8_t> : public cast_to_u8_gt<e3m2_t>
        {
        };
        template <>
        struct cast_gt<u8_t, e3m2_bits_t> : public cast_from_u8_gt<e3m2_t>
        {
        };
        template <>
        struct cast_gt<i8_t, u8_t> : public cast_to_u8_gt<i8_t>
        {
        };
        template <>
        struct cast_gt<u8_t, i8_t> : public cast_from_u8_gt<i8_t>
        {
        };
        ...
        struct casts_punned_t
        {
            ...
            template <typename scalar_at>
            static casts_punned_t make() noexcept
            {
            ...
            static casts_punned_t make(scalar_kind_t scalar_kind) noexcept
            {
                ...
                case scalar_kind_t::e5m2_k:
                    return casts_punned_t::make<e5m2_t>();
                case scalar_kind_t::e4m3_k:
                    return casts_punned_t::make<e4m3_t>();
                case scalar_kind_t::e3m2_k:
                    return casts_punned_t::make<e3m2_t>();
                case scalar_kind_t::e2m3_k:
                    return casts_punned_t::make<e2m3_t>();
                case scalar_kind_t::i8_k:
                    return casts_punned_t::make<i8_t>();
                case scalar_kind_t::u8_k:
                    return casts_punned_t::make<u8_t>();
                case scalar_kind_t::b1x8_k:
...
#pragma GCC ivdep
        ...
        inline nk_dtype_t scalar_kind_to_nk_dtype(scalar_kind_t sk) noexcept
        {
            ...
            {
            case scalar_kind_t::f64_k:
                return (nk_dtype_t)nk_f64_k;
            case scalar_kind_t::f32_k:
                return (nk_dtype_t)nk_f32_k;
            case scalar_kind_t::bf16_k:
                return (nk_dtype_t)nk_bf16_k;
            case scalar_kind_t::f16_k:
                return (nk_dtype_t)nk_f16_k;
            case scalar_kind_t::e5m2_k:
                return (nk_dtype_t)nk_e5m2_k;
            case scalar_kind_t::e4m3_k:
                return (nk_dtype_t)nk_e4m3_k;
            case scalar_kind_t::e3m2_k:
                return (nk_dtype_t)nk_e3m2_k;
            case scalar_kind_t::e2m3_k:
                return (nk_dtype_t)nk_e2m3_k;
            case scalar_kind_t::i8_k:
                return (nk_dtype_t)nk_i8_k;
            case scalar_kind_t::u8_k:
                return (nk_dtype_t)nk_u8_k;
            case scalar_kind_t::b1x8_k:
                return (nk_dtype_t)nk_u1_k;
            default:
                return (nk_dtype_t)0;
            }
        }
        ...
        private:
            ...
            bool configure_with_numkong(nk_capability_t simd_caps) noexcept
            {
                ...
                {
                case metric_kind_t::ip_k:
                    kind = nk_kernel_dot_k;
                    break;
                case metric_kind_t::cos_k:
                    kind = nk_kernel_angular_k;
                    break;
                case metric_kind_t::l2sq_k:
                    kind = nk_kernel_sqeuclidean_k;
                    break;
                case metric_kind_t::hamming_k:
                    kind = nk_kernel_hamming_k;
                    break;
                case metric_kind_t::tanimoto_k:
                    kind = nk_kernel_jaccard_k;
                    break;
                case metric_kind_t::jaccard_k:
                    kind = nk_kernel_jaccard_k;
                    break;
            ...
            void configure_with_autovec() noexcept
            {
                ...
                case metric_kind_t::ip_k:
                {
                    ...
                    case scalar_kind_t::f16_k:
                        ...
                        break;
                    case scalar_kind_t::e5m2_k:
                        metric_ptr_ = (uptr_t)&equidimensional_<metric_ip_gt<e5m2_t, f32_t>>;
                        break;
                    case scalar_kind_t::e4m3_k:
                        metric_ptr_ = (uptr_t)&equidimensional_<metric_ip_gt<e4m3_t, f32_t>>;
                        break;
                    case scalar_kind_t::e3m2_k:
                        metric_ptr_ = (uptr_t)&equidimensional_<metric_ip_gt<e3m2_t, f32_t>>;
                        break;
                    case scalar_kind_t::e2m3_k:
                        metric_ptr_ = (uptr_t)&equidimensional_<metric_ip_gt<e2m3_t, f32_t>>;
                        break;
                    case scalar_kind_t::i8_k:
                        metric_ptr_ = (uptr_t)&equidimensional_<metric_ip_gt<i8_t, f32_t>>;
                        break;
                    case scalar_kind_t::u8_k:
                        metric_ptr_ = (uptr_t)&equidimensional_<metric_ip_gt<u8_t, f32_t>>;
                        break;
                    default:
                        metric_ptr_ = 0;
                        break;
                ...
                case metric_kind_t::cos_k:
                {
                    ...
                    case scalar_kind_t::f16_k:
                        ...
                        break;
                    case scalar_kind_t::e5m2_k:
                        metric_ptr_ = (uptr_t)&equidimensional_<metric_cos_gt<e5m2_t, f32_t>>;
                        break;
                    case scalar_kind_t::e4m3_k:
                        metric_ptr_ = (uptr_t)&equidimensional_<metric_cos_gt<e4m3_t, f32_t>>;
                        break;
                    case scalar_kind_t::e3m2_k:
                        metric_ptr_ = (uptr_t)&equidimensional_<metric_cos_gt<e3m2_t, f32_t>>;
                        break;
                    case scalar_kind_t::e2m3_k:
                        metric_ptr_ = (uptr_t)&equidimensional_<metric_cos_gt<e2m3_t, f32_t>>;
                        break;
                    case scalar_kind_t::i8_k:
                        metric_ptr_ = (uptr_t)&equidimensional_<metric_cos_i8_t>;
                        break;
                    case scalar_kind_t::u8_k:
                        metric_ptr_ = (uptr_t)&equidimensional_<metric_cos_u8_t>;
                        break;
                    default:
                        metric_ptr_ = 0;
                        break;
                ...
                case metric_kind_t::l2sq_k:
                {
                    ...
                    case scalar_kind_t::f16_k:
                        ...
                        break;
                    case scalar_kind_t::e5m2_k:
                        metric_ptr_ = (uptr_t)&equidimensional_<metric_l2sq_gt<e5m2_t, f32_t>>;
                        break;
                    case scalar_kind_t::e4m3_k:
                        metric_ptr_ = (uptr_t)&equidimensional_<metric_l2sq_gt<e4m3_t, f32_t>>;
                        break;
                    case scalar_kind_t::e3m2_k:
                        metric_ptr_ = (uptr_t)&equidimensional_<metric_l2sq_gt<e3m2_t, f32_t>>;
                        break;
                    case scalar_kind_t::e2m3_k:
                        metric_ptr_ = (uptr_t)&equidimensional_<metric_l2sq_gt<e2m3_t, f32_t>>;
                        break;
                    case scalar_kind_t::i8_k:
                        metric_ptr_ = (uptr_t)&equidimensional_<metric_l2sq_i8_t>;
                        break;
                    case scalar_kind_t::u8_k:
                        metric_ptr_ = (uptr_t)&equidimensional_<metric_l2sq_u8_t>;
                        break;
                    default:
                        metric_ptr_ = 0;
                        break;
                ...
                case metric_kind_t::pearson_k:
                {
                    ...
                    case scalar_kind_t::i8_k:
                        ...
                        break;
                    case scalar_kind_t::u8_k:
                        metric_ptr_ = (uptr_t)&equidimensional_<metric_pearson_gt<u8_t, f32_t>>;
                        break;
                    default:
                        metric_ptr_ = 0;
                        break;
